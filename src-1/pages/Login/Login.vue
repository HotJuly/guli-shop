						...
						<div id="profile" class="tab-pane active">
							<form class="sui-form">
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="inputName" type="text" v-model="mobile" placeholder="邮箱/用户名/手机号" class="span2 input-xfat">
								</div>
...
export default {
    ...
    methods:{
      userLogin(){
        ...
        this.$store.dispatch('toLogin',{mobile,password:password,callback});
      },
      callback(){
        this.$router.go(-1);
      }
